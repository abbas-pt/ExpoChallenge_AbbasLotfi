...
* **Image Size:** $640 \times 640$ | **Batch Size:** 16
* **Augmentation Pipeline:** Mosaic (1.0), MixUp (0.15), Copy-Paste (0.10), Rotation ($\pm 15^\circ$), Perspective distortion ($0.0005$), HSV Jitter, and Random Erasing ($0.40$).
...
theta,Float,Gripper orientation angle in degrees (θ)
...
Arduino connected via USB (Optional: App automatically fallback to offline mode)
...
git clone [https://github.com/your-username/ECO-SORT-AI.git](https://github.com/your-username/ECO-SORT-AI.git)
cd ECO-SORT-AI
...
Place your model weights (best_abbas.pt) and dataset spec (data.yaml) in the project root.
